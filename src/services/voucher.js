// C:\Users\Bevis\Desktop\DATN_FE-develop\src\services\voucher.js
const API_URL = `${process.env.NEXT_PUBLIC_API_URL}/voucher`;
...
export { insertVoucher, getAllVouchers, getVoucherById, updateVoucher, deleteVoucher };