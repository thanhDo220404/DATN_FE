...
export default function sulydonhang() {
  return (
    <>
      <div className="container">
        ...
        <div className="text-right mt-4">
          ...
          <span className="text-danger">ĐÃ GIAO</span>
        </div>
        ...
        <div className="order-status position-relative d-flex justify-content-between mt-4">
          ...
          {/* Trạng thái "Đơn Hàng Đã Nhận" (hoàn thành) */}
          <div className="text-center">
            <div className="status-circle bg-success text-white d-flex justify-content-center align-items-center">
          ...
          <div className="text-center">
            <div className="status-circle bg-secondary text-white d-flex justify-content-center align-items-center"> {/* chưa hoàn thành */}
        ...
        <div className="btn-section mt-4 d-flex justify-content-around">
          <button className="btn btn-danger">Mua Lần Nữa</button>
        ...
        <div className="mt-4">
          <p className="text-center text-muted">
            Đơn hàng này đã hoàn thành. Vui lòng đánh giá các sản phẩm trước
            07-10-2020.
            <br />
